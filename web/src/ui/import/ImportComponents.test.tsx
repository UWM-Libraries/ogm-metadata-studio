...
describe('Import Components', () => {
  ...
  describe('ImportProgress', () => {
    ...
    it('renders found files and start button', () => {
      ...
      fireEvent.click(screen.getByText('Merge Import'));
      expect(onImport).toHaveBeenCalled();
    });

    it('offers an explicit repository rebuild for Aardvark sources', () => {
      ...
      fireEvent.click(screen.getByText('Rebuild from Repository'));
      expect(onRebuild).toHaveBeenCalled();
      expect(screen.getByText(/atomically replacing/)).toBeDefined();
    });
